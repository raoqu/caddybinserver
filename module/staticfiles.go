...
func init() {
	caddy.RegisterModule(BinServer{})
}

// BinServer implements a handler that serves static files.
//
...
func (BinServer) CaddyModule() caddy.ModuleInfo {
	return caddy.ModuleInfo{
		ID:  "http.handlers.bin_server",
		New: func() caddy.Module { return new(BinServer) },
	}
}

// Provision sets up the static files responder.
func (fsrv *BinServer) Provision(ctx caddy.Context) error {
...
func (fsrv *BinServer) ServeHTTP(w http.ResponseWriter, r *http.Request, next caddyhttp.Handler) error {
...
func (fsrv *BinServer) openFile(filename string, w http.ResponseWriter) (fs.File, error) {
...
func (fsrv *BinServer) mapDirOpenError(originalErr error, name string) error {
...
func (fsrv *BinServer) transformHidePaths(repl *caddy.Replacer) []string {
...
func (fsrv *BinServer) notFound(w http.ResponseWriter, r *http.Request, next caddyhttp.Handler) error {
	if fsrv.PassThru {
...
// Interface guards
var (
	_ caddy.Provisioner           = (*BinServer)(nil)
	_ caddyhttp.MiddlewareHandler = (*BinServer)(nil)

	_ fs.StatFS     = (*BinFS)(nil)
	_ fs.GlobFS     = (*BinFS)(nil)
	_ fs.ReadDirFS  = (*BinFS)(nil)
	_ fs.ReadFileFS = (*BinFS)(nil)
)
